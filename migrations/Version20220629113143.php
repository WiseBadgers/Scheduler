 ...
 */
final class Version20220629113143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE user_id student_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE student_id user_id INT DEFAULT NULL');
