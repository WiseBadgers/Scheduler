 ...
 */
final class Version20220703080121 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id VARCHAR(255) NOT NULL, teacher_id VARCHAR(255) DEFAULT NULL, semester_id VARCHAR(255) DEFAULT NULL, subject_id VARCHAR(255) DEFAULT NULL, school_class_id VARCHAR(255) DEFAULT NULL, INDEX IDX_169E6FB941807E1D (teacher_id), INDEX IDX_169E6FB94A798B6F (semester_id), INDEX IDX_169E6FB923EDC87 (subject_id), INDEX IDX_169E6FB914463F54 (school_class_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE school_class (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
